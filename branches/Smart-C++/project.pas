...
begin
    ...
    ResFile.Add('/* THIS FILE WILL BE OVERWRITTEN BY SMART-C++ */');
    ...
    with finifile do begin
        ...
        if (fOptions.Ver > 0) then begin // ver > 0 is at least a v5 project
            ...
            if (fOptions.Ver < 2) then begin
                fOptions.Ver := 2;
                { TODO 2 -oSXKDZ -cTranslation : Д§З­вы }
                MessageDlg('The compiler settings format of Dev-C++ has changed.' + #13#10#13#10 + 'Please update your settings at Project >> Project Options >> Compiler and save your project.', MtInformation, [MbOK], 0);
            end;
