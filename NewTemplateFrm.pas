...
uses
    utils, IconFrm, devcfg, version, Templates;
...
begin
    ...
    cmbName.Text := '自定义工程';
    txtDescr.Text := '这是一个自定义的工程';
    txtProjName.Text := '自定义工程';
...
begin
    ...
    with tmpIni do try
        ...
        MessageDlg('新的模板已经成功创建！'#10#10 +
            '您可以在“新建工程”窗口中找到 "' + cmbName.Text + '" under the "' + cmbCateg.Text + '" 。',
